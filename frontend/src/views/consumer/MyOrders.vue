    ...
    <div class="page-container">
        ...
        <div class="filter-bar">
            ...
            <div class="status-tabs">
                ...
                <button 
                    :class="['tab-btn', { active: currentStatus === 'shipping' }]" 
            ...
            <div v-else class="order-item" v-for="order in orders" :key="order.orderId">
                ...
                <div class="order-content">
                    ...
                    <div class="order-actions">
                        <button v-if="order.status === 2" class="action-btn primary-btn" @click="confirmReceipt(order.orderId)">
                            确认收货
                        </button>
                        <button v-if="order.status === 3" class="action-btn success-btn" @click="viewEvaluation(order.orderId)">
                            查看评价
                        </button>
                    </div>
                </div>
...
const confirmReceipt = async (orderId) => {
    ...
    try {
        ...
        const res = await request.put(`/orders/${orderId}/confirm`, null, {
